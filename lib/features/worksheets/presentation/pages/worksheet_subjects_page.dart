...
/// Entry point for "أوراق العمل" — pick a subject first, then browse that
/// subject's worksheets.
class WorksheetSubjectsPage extends StatelessWidget {
  const WorksheetSubjectsPage({super.key});
